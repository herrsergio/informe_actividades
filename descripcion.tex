...
En ellos se encuentra el número de inventario del producto a deplegar en el reporte. A continuación se muestra como ejemplo una parte del archivo de \texttt{Servicio.conf}:
